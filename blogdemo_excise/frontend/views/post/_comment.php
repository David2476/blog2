...
<!--<script type="text/javascript" src="/blogdemo_excise/frontend/web/js/jquery-1.12.0.min.js"></script>-->
<!--<script type="text/javascript" src="/blogdemo_excise/frontend/web/js/jquery.flexText.js"></script>-->
...
<script type="text/javascript">
    $('.comment-show').on('click','.hf-pl',function(){
        ...
        if(oHfVal.replace(/^ +| +$/g,'') == '' || oHfVal == oAllVal){
            ...
            $.getJSON("/blogdemo_excise/frontend/web/json/pl.json",function(data){
                var oAt = '';
                var oHf = '';
